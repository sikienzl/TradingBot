...
| `UPTREND_ENTRY_MIN_BUY_PROBA_BY_COIN` | `TRX:0.155` | Coin-specific CatBoost buy-probability override for uptrend entry gating |
...
UPTREND_ENTRY_MIN_BUY_PROBA_BY_COIN=TRX:0.155
